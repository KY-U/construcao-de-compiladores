...
public class LinguagemAlgoritmicaLexer extends Lexer {
	...
	public static final int
		...
		MAIOR=27, MENOR=28, MAIOR_IGUAL=29, MENOR_IGUAL=30, E=31, NAO=32, OU=33, 
		...
		TIPO=54, VAR=55, CONST=56, VERDADEIRO=57, FALSO=58, CONJUNTO=59, IDENT=60, 
		WS=61, DELIM=62, ABRECOL=63, FECHACOL=64, ABREPAR=65, FECHAPAR=66;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"REGISTRO", "FIM_REGISTRO", "PONTO", "IGUAL", "DIFERENTE", "MAIOR", "MENOR", 
			"MAIOR_IGUAL", "MENOR_IGUAL", "E", "NAO", "OU", "LOGICO", "SE", "ENTAO", 
			...
			"CONST", "VERDADEIRO", "FALSO", "CONJUNTO", "IDENT", "ESC_SEQ", "WS", 
			"DELIM", "ABRECOL", "FECHACOL", "ABREPAR", "FECHAPAR"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ATE", "FACA", "FIM_PARA", "ENQUANTO", "FIM_ENQUANTO", "PROCEDIMENTO", 
			"FIM_PROCEDIMENTO", "FUNCAO", "RETORNE", "FIM_FUNCAO", "TIPO", "VAR", 
			"CONST", "VERDADEIRO", "FALSO", "CONJUNTO", "IDENT", "WS", "DELIM", "ABRECOL", 
			"FECHACOL", "ABREPAR", "FECHAPAR"
		};
	}
